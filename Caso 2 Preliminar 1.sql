...
CREATE TABLE IF NOT EXISTS `Copos`.`inventories` (
  ...
  INDEX `fk_inventories_ingredients1_idx` (`ingredient_id` ASC) VISIBLE,
  CONSTRAINT `fk_ingredientes_por_carrito_carritos1`
    FOREIGN KEY (`car_id`)
    REFERENCES `Copos`.`cars` (`car_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_inventories_ingredients1`
    FOREIGN KEY (`ingredient_id`)
    REFERENCES `Copos`.`ingredients` (`ingredient_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `Copos`.`inventory_checks` (
  ...
  `second_copero` INT NULL,
  `created_at` DATETIME NOT NULL,
  `updated_at` DATETIME NOT NULL,
  `computer` VARCHAR(45) NOT NULL,
  `username` VARCHAR(45) NOT NULL,
  `checksum` VARBINARY(150) NOT NULL,
  `real_amount` DECIMAL(12,2) NULL,
  ...
  INDEX `fk_inventory_checks_inventories1_idx` (`inventory_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_inventory_checks_coperos2`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_inventory_checks_inventories1`
    FOREIGN KEY (`inventory_id`)
    REFERENCES `Copos`.`inventories` (`inventory_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Copos`.`copero_payments` (
  ...
  INDEX `fk_copero_payments_invoices1_idx` (`invoice_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Copos`.`cashbox_checks` (
  ...
  INDEX `fk_cashbox_checks_cashboxes1_idx` (`cashbox_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_box_checks_coperos2`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_cashbox_checks_cashboxes1`
    FOREIGN KEY (`cashbox_id`)
    REFERENCES `Copos`.`cashboxes` (`cashbox_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
